const { createUser, getUser, createConstraintIfNotExists } = require('./lib/users')
...
const { searchByPhrase, createIndexIfNotExists } = require('./lib/search')
const { recommendationForUser } = require('./lib/recommendation')
...
app.get('/', async (req, res) => {
    ...
    const recom = await recommendationForUser(2)
    console.log(recom)
